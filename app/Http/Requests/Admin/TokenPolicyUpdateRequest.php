...
class TokenPolicyUpdateRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        $tokenPolicy = $this->route('tokenPolicy');

        return [
            'name' => ['required', 'string', 'max:255'],
            'code' => ['required', 'string', 'max:150', 'regex:/^[a-z0-9._-]+$/', Rule::unique('token_policies', 'code')->ignore($tokenPolicy->id)],
