...
namespace PHPSTORM_META {
    ...
    */
    override(new \Illuminate\Contracts\Container\Container, map([
        '' => '@',
            'App\Repositories\Contracts\ClientRepositoryInterface' => \App\Repositories\ClientRepository::class,
            'App\Repositories\Contracts\ClientUserAccessRepositoryInterface' => \App\Repositories\ClientUserAccessRepository::class,
            'App\Repositories\Contracts\PermissionRepositoryInterface' => \App\Repositories\PermissionRepository::class,
            'App\Repositories\Contracts\RoleRepositoryInterface' => \App\Repositories\RoleRepository::class,
            'App\Repositories\Contracts\ScopeRepositoryInterface' => \App\Repositories\ScopeRepository::class,
            'App\Repositories\Contracts\TokenPolicyRepositoryInterface' => \App\Repositories\TokenPolicyRepository::class,
            'App\Repositories\Contracts\TokenRepositoryInterface' => \App\Repositories\TokenRepository::class,
            'App\Repositories\Contracts\UserClientConsentRepositoryInterface' => \App\Repositories\UserClientConsentRepository::class,
    ...
    override(\config(), map([
            ...
            'activitylog.default_auth_driver' => 'string',
            ...
            'filesystems.links.C:\wamp64\www\sso\sso_server\public\storage' => 'string',
            ...
            'oidc.issuer' => 'string',
            'oidc.id_token_ttl_seconds' => 'integer',
            'oidc.backchannel_logout_token_ttl_seconds' => 'integer',
            'oidc.signing.active_kid' => 'string',
            'oidc.signing.registry_path' => 'string',
            'oidc.signing.key_directory' => 'string',
            'oidc.signing.openssl_config_path' => 'NULL',
            'oidc.signing.retiring_grace_period_seconds' => 'integer',
            'oidc.signing.keys.0.kid' => 'string',
            'oidc.signing.keys.0.status' => 'string',
            'oidc.signing.keys.0.alg' => 'string',
            'oidc.signing.keys.0.private_key_path' => 'string',
            'oidc.signing.keys.0.public_key_path' => 'string',
            'oidc.signing.keys.0.published' => 'boolean',
            ...
            'services.oauth.consent_context_ttl_minutes' => 'integer',
            'services.oauth.remembered_consent_ttl_days' => 'integer',
            'services.oauth.consent_policy_version' => 'string',
...
'viewAny','view','create','update','viewSelf',
'updateSelf','updateOwnPassword','delete','bulkDelete','manageSecrets',
'rotateSecret','revokeSecret','revoke','revokeFamily',);
...
'filesystems.disks.s3.use_path_style_endpoint','filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.links.C:\\wamp64\\www\\sso\\sso_server\\public\\storage','ide-helper.filename',
...
'mail.markdown.theme','mail.markdown.paths','mail.markdown.extensions','oidc.issuer','oidc.id_token_ttl_seconds',
'oidc.backchannel_logout_token_ttl_seconds','oidc.signing.active_kid','oidc.signing.registry_path','oidc.signing.key_directory','oidc.signing.openssl_config_path',
'oidc.signing.retiring_grace_period_seconds','oidc.signing.keys.0.kid','oidc.signing.keys.0.status','oidc.signing.keys.0.alg','oidc.signing.keys.0.private_key_path',
'oidc.signing.keys.0.public_key_path','oidc.signing.keys.0.published','permission.models.permission','permission.models.role','permission.table_names.roles',
...
'queue.failed.database','queue.failed.table','repository.pagination.limit','services.postmark.key','services.resend.key',
...
'services.oauth.consent_context_ttl_minutes','services.oauth.remembered_consent_ttl_days','services.oauth.consent_policy_version','session.driver','session.lifetime',
...
'sanctum.csrf-cookie','oauth.token','oauth.revoke','oauth.introspect','oauth.userinfo',
'profile.show','profile.update','profile.password.update','api.client-user-access.index','api.client-user-access.store',
'api.client-user-access.bulk-destroy','api.client-user-access.update','api.client-user-access.destroy','api.sso-clients.user-accesses','api.users.client-accesses','locale.update','oidc.discovery','oidc.jwks',
'oidc.end_session','oauth.authorize','oauth.authorize.approve','oauth.authorize.deny','dashboard',
'admin.users.index','admin.users.store','admin.users.bulk-destroy','admin.users.update','admin.users.destroy',
'admin.roles.index','admin.roles.create','admin.roles.store','admin.roles.bulk-destroy','admin.roles.edit',
'admin.roles.update','admin.roles.destroy','admin.permissions.index','admin.permissions.create','admin.permissions.store',
'admin.permissions.bulk-destroy','admin.permissions.edit','admin.permissions.update','admin.permissions.destroy','admin.sso-clients.index',
'admin.sso-clients.create','admin.sso-clients.store','admin.sso-clients.edit','admin.sso-clients.update','admin.sso-clients.rotate-secret',
'admin.sso-clients.revoke-secret','admin.sso-clients.destroy','admin.client-user-access.index','admin.client-user-access.create','admin.client-user-access.store',
'admin.client-user-access.edit','admin.client-user-access.update','admin.scopes.index','admin.scopes.create','admin.scopes.store',
'admin.scopes.bulk-destroy','admin.scopes.edit','admin.scopes.update','admin.scopes.destroy','admin.token-policies.index',
'admin.token-policies.create','admin.token-policies.store','admin.token-policies.bulk-destroy','admin.token-policies.edit','admin.token-policies.update',
'admin.token-policies.destroy','admin.tokens.index','admin.tokens.revoke','admin.tokens.revoke-family','admin.remembered-consents.index',
'admin.remembered-consents.revoke','admin.audit-logs.index','profile.edit','profile.update','profile.destroy',
...
'app','oidc.frontchannel-logout','laradumps::output','laradumps::summary','laravel-exceptions-renderer::components.badge',
...
'C:.wamp64.www.sso.sso_server.vendor.laravel.framework.src.Illuminate.Translation.lang.en.auth.failed','C:.wamp64.www.sso.sso_server.vendor.laravel.framework.src.Illuminate.Translation.lang.en.auth.password','C:.wamp64.www.sso.sso_server.vendor.laravel.framework.src.Illuminate.Translation.lang.en.auth.throttle','C:.wamp64.www.sso.sso_server.vendor.laravel.framework.src.Illuminate.Translation.lang.en.pagination.previous','C:.wamp64.www.sso.sso_server.vendor.laravel.framework.src.Illuminate.Translation.lang.en.pagination.next',
'C:.wamp64.www.sso.sso_server.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.reset','C:.wamp64.www.sso.sso_server.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.sent','C:.wamp64.www.sso.sso_server.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.throttled','C:.wamp64.www.sso.sso_server.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.token','C:.wamp64.www.sso.sso_server.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.user',
'C:.wamp64.www.sso.sso_server.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.accepted','C:.wamp64.www.sso.sso_server.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.accepted_if','C:.wamp64.www.sso.sso_server.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.active_url','C:.wamp64.www.sso.sso_server.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.after','C:.wamp64.www.sso.sso_server.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.after_or_equal',
'C:.wamp64.www.sso.sso_server.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.alpha','C:.wamp64.www.sso.sso_server.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.alpha_dash','C:.wamp64.www.sso.sso_server.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.alpha_num','C:.wamp64.www.sso.sso_server.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.any_of','C:.wamp64.www.sso.sso_server.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.array',
'C:.wamp64.www.sso.sso_server.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ascii','C:.wamp64.www.sso.sso_server.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.before','C:.wamp64.www.sso.sso_server.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.before_or_equal','C:.wamp64.www.sso.sso_server.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.array','C:.wamp64.www.sso.sso_server.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.file',
'C:.wamp64.www.sso.sso_server.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.numeric','C:.wamp64.www.sso.sso_server.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.string','C:.wamp64.www.sso.sso_server.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.boolean','C:.wamp64.www.sso.sso_server.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.can','C:.wamp64.www.sso.sso_server.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.confirmed',
'C:.wamp64.www.sso.sso_server.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.contains','C:.wamp64.www.sso.sso_server.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.current_password','C:.wamp64.www.sso.sso_server.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.date','C:.wamp64.www.sso.sso_server.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.date_equals','C:.wamp64.www.sso.sso_server.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.date_format',
'C:.wamp64.www.sso.sso_server.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.decimal','C:.wamp64.www.sso.sso_server.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.declined','C:.wamp64.www.sso.sso_server.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.declined_if','C:.wamp64.www.sso.sso_server.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.different','C:.wamp64.www.sso.sso_server.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.digits',
'C:.wamp64.www.sso.sso_server.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.digits_between','C:.wamp64.www.sso.sso_server.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.dimensions','C:.wamp64.www.sso.sso_server.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.distinct','C:.wamp64.www.sso.sso_server.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.doesnt_contain','C:.wamp64.www.sso.sso_server.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.doesnt_end_with',
'C:.wamp64.www.sso.sso_server.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.doesnt_start_with','C:.wamp64.www.sso.sso_server.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.email','C:.wamp64.www.sso.sso_server.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.encoding','C:.wamp64.www.sso.sso_server.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ends_with','C:.wamp64.www.sso.sso_server.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.enum',
'C:.wamp64.www.sso.sso_server.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.exists','C:.wamp64.www.sso.sso_server.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.extensions','C:.wamp64.www.sso.sso_server.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.file','C:.wamp64.www.sso.sso_server.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.filled','C:.wamp64.www.sso.sso_server.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.array',
'C:.wamp64.www.sso.sso_server.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.file','C:.wamp64.www.sso.sso_server.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.numeric','C:.wamp64.www.sso.sso_server.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.string','C:.wamp64.www.sso.sso_server.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.array','C:.wamp64.www.sso.sso_server.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.file',
'C:.wamp64.www.sso.sso_server.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.numeric','C:.wamp64.www.sso.sso_server.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.string','C:.wamp64.www.sso.sso_server.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.hex_color','C:.wamp64.www.sso.sso_server.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.image','C:.wamp64.www.sso.sso_server.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.in',
'C:.wamp64.www.sso.sso_server.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.in_array','C:.wamp64.www.sso.sso_server.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.in_array_keys','C:.wamp64.www.sso.sso_server.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.integer','C:.wamp64.www.sso.sso_server.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ip','C:.wamp64.www.sso.sso_server.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ipv4',
'C:.wamp64.www.sso.sso_server.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ipv6','C:.wamp64.www.sso.sso_server.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.json','C:.wamp64.www.sso.sso_server.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.list','C:.wamp64.www.sso.sso_server.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lowercase','C:.wamp64.www.sso.sso_server.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.array',
'C:.wamp64.www.sso.sso_server.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.file','C:.wamp64.www.sso.sso_server.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.numeric','C:.wamp64.www.sso.sso_server.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.string','C:.wamp64.www.sso.sso_server.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.array','C:.wamp64.www.sso.sso_server.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.file',
'C:.wamp64.www.sso.sso_server.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.numeric','C:.wamp64.www.sso.sso_server.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.string','C:.wamp64.www.sso.sso_server.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.mac_address','C:.wamp64.www.sso.sso_server.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.array','C:.wamp64.www.sso.sso_server.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.file',
'C:.wamp64.www.sso.sso_server.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.numeric','C:.wamp64.www.sso.sso_server.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.string','C:.wamp64.www.sso.sso_server.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max_digits','C:.wamp64.www.sso.sso_server.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.mimes','C:.wamp64.www.sso.sso_server.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.mimetypes',
'C:.wamp64.www.sso.sso_server.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.array','C:.wamp64.www.sso.sso_server.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.file','C:.wamp64.www.sso.sso_server.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.numeric','C:.wamp64.www.sso.sso_server.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.string','C:.wamp64.www.sso.sso_server.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min_digits',
'C:.wamp64.www.sso.sso_server.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing','C:.wamp64.www.sso.sso_server.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_if','C:.wamp64.www.sso.sso_server.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_unless','C:.wamp64.www.sso.sso_server.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_with','C:.wamp64.www.sso.sso_server.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_with_all',
'C:.wamp64.www.sso.sso_server.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.multiple_of','C:.wamp64.www.sso.sso_server.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.not_in','C:.wamp64.www.sso.sso_server.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.not_regex','C:.wamp64.www.sso.sso_server.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.numeric','C:.wamp64.www.sso.sso_server.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.letters',
'C:.wamp64.www.sso.sso_server.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.mixed','C:.wamp64.www.sso.sso_server.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.numbers','C:.wamp64.www.sso.sso_server.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.symbols','C:.wamp64.www.sso.sso_server.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.uncompromised','C:.wamp64.www.sso.sso_server.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present',
'C:.wamp64.www.sso.sso_server.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_if','C:.wamp64.www.sso.sso_server.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_unless','C:.wamp64.www.sso.sso_server.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_with','C:.wamp64.www.sso.sso_server.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_with_all','C:.wamp64.www.sso.sso_server.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited',
'C:.wamp64.www.sso.sso_server.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_if','C:.wamp64.www.sso.sso_server.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_if_accepted','C:.wamp64.www.sso.sso_server.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_if_declined','C:.wamp64.www.sso.sso_server.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_unless','C:.wamp64.www.sso.sso_server.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibits',
'C:.wamp64.www.sso.sso_server.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.regex','C:.wamp64.www.sso.sso_server.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required','C:.wamp64.www.sso.sso_server.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_array_keys','C:.wamp64.www.sso.sso_server.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_if','C:.wamp64.www.sso.sso_server.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_if_accepted',
'C:.wamp64.www.sso.sso_server.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_if_declined','C:.wamp64.www.sso.sso_server.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_unless','C:.wamp64.www.sso.sso_server.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_with','C:.wamp64.www.sso.sso_server.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_with_all','C:.wamp64.www.sso.sso_server.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_without',
'C:.wamp64.www.sso.sso_server.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_without_all','C:.wamp64.www.sso.sso_server.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.same','C:.wamp64.www.sso.sso_server.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.array','C:.wamp64.www.sso.sso_server.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.file','C:.wamp64.www.sso.sso_server.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.numeric',
'C:.wamp64.www.sso.sso_server.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.string','C:.wamp64.www.sso.sso_server.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.starts_with','C:.wamp64.www.sso.sso_server.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.string','C:.wamp64.www.sso.sso_server.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.timezone','C:.wamp64.www.sso.sso_server.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.unique',
'C:.wamp64.www.sso.sso_server.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.uploaded','C:.wamp64.www.sso.sso_server.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.uppercase','C:.wamp64.www.sso.sso_server.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.url','C:.wamp64.www.sso.sso_server.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ulid','C:.wamp64.www.sso.sso_server.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.uuid',
'C:.wamp64.www.sso.sso_server.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.custom.attribute-name.rule-name','api.oauth.authorization_denied','api.oauth.authentication_failed','api.oauth.userinfo.retrieved','api.oauth.token.issued',
'api.oauth.token.request_failed','api.oauth.revoke.request_failed','api.oauth.introspect.completed','api.oauth.introspect.failed','api.oauth.consent.review_description',
'api.oauth.consent.token_invalid','api.oauth.consent.token_user_mismatch','api.oauth.consent.token_client_invalid','api.oauth.client_invalid_or_inactive','api.oauth.redirect_uri_mismatch',
'api.oauth.scope_not_allowed','api.oauth.pkce_required','api.oauth.code_challenge_method_s256','api.clients.created','api.clients.updated',
'api.clients.deleted','api.clients.secret_rotated','api.clients.secret_revoked','api.users.created','api.users.updated',
'api.users.deleted','api.users.bulk_deleted','api.roles.created','api.roles.updated','api.roles.deleted',
'api.roles.bulk_deleted','api.permissions.created','api.permissions.updated','api.permissions.deleted','api.permissions.bulk_deleted',
'api.scopes.created','api.scopes.updated','api.scopes.deleted','api.scopes.bulk_deleted','api.token_policies.created',
'api.token_policies.updated','api.token_policies.deleted','api.token_policies.bulk_deleted','api.tokens.revoked','api.tokens.family_not_found',
'api.tokens.family_revoked','api.tokens.family_already_revoked','api.client_user_access.records_retrieved','api.client_user_access.created','api.client_user_access.updated',
'api.client_user_access.deleted','api.client_user_access.bulk_deleted','api.client_user_access.client_assignments_retrieved','api.client_user_access.user_assignments_retrieved','messages.forbidden',
'validation.custom.refresh_token_ttl_minutes.gte_access_token_ttl','validation.custom.reuse_refresh_token_forbidden.requires_rotation','validation.custom.is_active.default_policy_must_be_active','validation.custom.code_challenge_method.required_with_code_challenge','validation.custom.code_challenge.required_with_code_challenge_method',
'validation.custom.nonce.required_for_openid_scope','validation.custom.self_service_profile.forbidden_field','validation.custom.self_service_password.forbidden_field','auth.failed','auth.password',
'auth.throttle','passwords.reset','passwords.sent','passwords.throttled','passwords.token',
'passwords.user',);
        registerArgumentsSet('env', 
'APP_NAME','APP_ENV','APP_KEY','APP_DEBUG','APP_URL',
'APP_TIMEZONE','OIDC_ISSUER','OIDC_SIGNING_ALG','OIDC_SIGNING_KID','OIDC_SIGNING_PRIVATE_KEY_PATH',
'OIDC_SIGNING_PUBLIC_KEY_PATH','APP_LOCALE','APP_FALLBACK_LOCALE','APP_FAKER_LOCALE','APP_MAINTENANCE_DRIVER',
...
'AWS_DEFAULT_REGION','AWS_BUCKET','AWS_USE_PATH_STYLE_ENDPOINT','VITE_APP_NAME','LARADUMPS_ENABLED',);
