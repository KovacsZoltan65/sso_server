...
<template>
    ...
    >
        <div
            :class="[
                'grid min-w-0 gap-5',
                isModalLayout ? 'xl:col-span-1' : 'xl:col-span-2',
            ]"
        >
            <div class="grid gap-4 md:grid-cols-2">
                <div class="grid gap-2">
                    ...
                    <Select
                        ...
                        optionLabel="label"
                        optionValue="value"
                        :placeholder="trans('actions.select_client')"
                        class="w-full"
                        :disabled="disabled"
                    />
                ...
                <div class="grid gap-2">
                    ...
                    <Select
                        ...
                        optionLabel="label"
                        optionValue="value"
                        :placeholder="trans('actions.select_user')"
                        class="w-full"
                        :disabled="disabled"
                    />
        ...
        >
            <div class="grid gap-2">
                ...
                >
                    <Checkbox
                        ...
                        :disabled="disabled"
                    />
                    <label class="text-sm text-slate-700" for="access-active"
                        >Access is active</label
                    >
                </div>
                <small v-if="form.errors.is_active" class="text-red-600">{{
            ...
            >
                ...
                <p class="mt-1 leading-6 text-amber-800">
                    When a client has no active access records, it remains open. Adding at
                    least one active record restricts authorization to explicitly assigned
                    users.
                </p>
            </div>
            ...
            >
                ...
                <p class="mt-1 leading-6 text-sky-800">
                    Leave the allowed-from and allowed-until values empty to grant access
                    without a time-bound window.
                </p>
            </div>
        </div>
    </div>
