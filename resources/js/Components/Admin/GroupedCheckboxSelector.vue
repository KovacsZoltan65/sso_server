...
const groupedOptions = computed(() => {
    ...
    props.options.forEach((option) => {
        ...
        const [parsedResource = 'misc', parsedAction = optionValue] = String(optionValue).split('.');
        ...
        const itemLabel = option.itemLabel ?? prettifyAction(String(action === optionValue ? optionLabel : action));
